...
const CategoryDetailPage = () => {
      ...
      if (response.success) {
        ...
        if (
          (!response.category.children ||
            response.category.children.length === 0) &&
          response.category.services &&
          response.category.services.length > 0
        ) {
  ...
  const pageDescription =
    ...
    `تصفح خدمات ${category.name || ""} على منصة BuildingZ`;
  const pageUrl = `${window.location.origin}/services2/categories/${
    category.id || "category"
  }-${categorySlug}`;
  const categoryImage = serviceBuilderService.getImageUrl(
  ...
  return (
    <div className="category-detail-page">
      <Helmet>
        ...
        <meta
          name="keywords"
          content={`${category.name}, خدمات, BuildingZ, هندسة, إنشاءات`}
        />
                    ...
                    {viewMode === "grid" && (
                      <div className="subcategory-content">
                        ...
                        <div className="subcategory-footer">
                          ...
                          <button className="subcategory-action-btn">
                            عرض الفئة
                          </button>
                        </div>
                      </div>
